...
export function I18NProvider({ children }) {
  ...
  const t = useCallback(
    ...
    [locale] //este locale cuando cambia ejecutar el callback t. este t es el que se usa en el componente. cuando cambia el locale se ejecuta el callback t. y se actualiza el componente. el useCallback es para memorizar una funcion, osea sirve mas para funciones, el useEffect ejecuta codigo arbitrario. el useMemo es como el useCallback pero para valores(filtrar arrays, etc)
  );
